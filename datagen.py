...
class example_dataset(Dataset):
    ...
    def __init__(self, data_dir = cfg.predict_data_dir, transform = None):
    ...
    def __getitem__(self, idx):
        ...
        i_t = io.imread(os.path.join(cfg.predict_data_dir, img_name + 'i_t.png'))
        i_s = io.imread(os.path.join(cfg.predict_data_dir, img_name + 'i_s.png'))
        h, w = i_t.shape[:2]
